...
function move_left()//give the LEFT direction and update position for the ant
{
    switch(g_bot.dir)
    {
...
function move_right()//give the LEFT direction and update position for the ant
{
    switch(g_bot.dir)
    {
...
function move_bot( )//give the direction and update position for the ant
{
    dx=0;
    dy=0;
    switch (g_bot.color) {
